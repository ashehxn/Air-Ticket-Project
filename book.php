...
<body>
    ...
    <div class="book-description-box">
        <div class="book-description">
            ...
            <ul>
                <li>Access the website's flight booking page and input your departure and destination cities, as well as your desired travel dates.</li>
                <li>Select the number of passengers and choose the cabin class for your flight.</li>
                <li>Fill in your personal information, including name, contact details, and payment method, to finalize the booking.</li>
            </ul>
        </div>
    </div>
